...
fun Application.configureUserRouting(userController: UserController) {
    routing {
        post("/register") {
            ...
            val createdUser = userController.registerUser(registrationRequest)
...
@Serializable
data class RegistrationRequest(val fullName: String, val phoneNumber: String, val email: String, val password: String)